      ...
      <div class="container">
         <div class="boxabt">
            <div>
               ...
               <a href="http://wanderersbrews.in/wanderers-blog/">Read more..</a>
            </div>
            <div>
         ...
         <div class="boxabt">
            <div>
               ...
               <a href="http://wanderersbrews.in/beer-brewing/">Read more..</a>
            </div>
            <div>
         ...
         <div class="sustainflex">
            <div>
               ...
               <ul>
                  ...
                  <li>Re-using treated water within our brew-pub and reducing our water requirement and footprint;</li>
               ...
               <div>
                  <a href="<?php the_permalink(); ?>">
                     <div class="recntlink">
                        ...
                        <div>
                           <small><?php echo get_the_date('F Y', $post->ID); ?> / by <?php echo get_the_author_meta('display_name', $post->post_author); ?></small>
                           <h5><?php the_title(); ?></h5>
                        </div>
                     </div>
                  </a>
