...
/* Ready function */
	$(function() {
		...
		/* Move Menu Down */
		$(document).on('click', '.movemenudown', function(){
    ...
    if($('body').hasClass('home')) {
      ...
      $('nav > ul > li:nth-child(4) a, nav > ul > li:nth-child(5) a').addClass('movemenudown');
      hashscroll($('nav > ul > li:nth-child(4) a'));
      hashscroll($('nav > ul > li:nth-child(5) a'));
    }

    function hashscroll(identity) {
      var cont = identity.attr('href');
      var position = cont.indexOf("#");
      identity.attr('href', cont.substr(position));
    }
